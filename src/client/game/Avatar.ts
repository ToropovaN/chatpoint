    ...
    this.scene.registerBeforeRender(() => {
      ...
      if (this.mesh.position.z < 23.5) {
        if (
          ...
          (this.mesh.position.x < 5.8 && this.mesh.position.z > -3.4) ||
          (this.mesh.position.x < 17 && this.mesh.position.z > 9.8)
        ) {
      ...
      if (this.mesh.position.z > 23.5) {
        if (this.mesh.position.x < -43 && this._currMapSector !== 0)
          this.animateCamRot(0);
        if (this.mesh.position.x > -43 && this._currMapSector !== 1)
